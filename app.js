...
ifHeCared.displayResults = function (question3Answer) {
    $('.cta3').on('click', function (event) {
        ...
        if (question3Answer === 'ProtectingForests') {
            ...
            $('.land').addClass('hidden')
            $('.results').html('<p>With Jeff Bezos\'s net worth he could build enough solar farms to power over 36 million homes <a href="https://energycentral.com/c/gn/initial-steps-building-solar-farm" target="_blank">more information here</a></p>')
